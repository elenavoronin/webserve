...
class CGI {
	...
	private:
		...
		std::string _contentLength;                 // Store the content length for POST requests
	...
	public:
		...
		void handleParentProcess(int client_socket, HttpRequest &request); // Handle parent process communication with the CGI
		...
		void readCgiOutput(int client_socket, HttpRequest &request);        // Read CGI output from the response pipe
...
//         // Read data from the request pipe
//         int bytesRead = read(request.getRequestPipeFd(), buffer, bufferSize);
//         // Process the request
//         // ...
//     }

//     void sendResponse(HttpResponse &response) {
//         // Write data to the response pipe
//         int bytesWritten = write(response.getResponsePipeFd(), responseBuffer, responseBufferSize);
//         // ...
//     }
// };